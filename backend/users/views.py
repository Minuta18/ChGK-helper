...
def edit_user(user_id: int):
    ...
    Args:
        time_for_reading (:obj:`int`): New time for reading setting of the user.
        time_for_solving (:obj:`int`): New time for solving setting of the user.
        time_for_typing (:obj:`int`): New time for typing setting of the user.
    '''
    ...
    return flask.jsonify({
        ...
        'time_for_solving': time_for_solving,
        'time_for_typing': time_for_typing,
    }), 200
